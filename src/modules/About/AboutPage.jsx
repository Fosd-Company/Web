          ...
          <div className="col-lg-8">
            <div className="card-page">
              ...
              <p>
                ...
                debido a sus múltiples aplicaciones. Se puede extrapolar a
                campos tan variados como entretenimiento,publicidad,educación,
              ...
              <p>
                ...
                Hackathon Nicaragua, pasando por cada una de sus fases de
                proceso creativo, clasificación y preparación hasta lograr
                destacar como segundo lugar en su categoría de aficionados
                siendo su primera experiencia en la plataforma.
              </p>
              <p>
                Nic-ARTeam es una muestra de que a partir de una simple idea se
                puede formar un proyecto real aportando soluciones informáticas
                y fomentando el emprendimiento entre los jóvenes. Actualmente se
